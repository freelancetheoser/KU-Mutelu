          ...
          <Dialog.Root>
            <Dialog.Trigger asChild>
                <button className='w-16 h-16 m-2 flex-shrink-0 flex justify-center items-center  overflow-hidden rounded-full border-2 border-teal-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-plus-circle-dotted text-teal-500" viewBox="0 0 16 16">
              ...
              <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                ...
                <div className="mt-[25px] flex justify-center">
                  <Dialog.Close asChild>
                    <button onClick={handleSubmit} className="rounded-full bg-gradient-to-r from-[#005555] to-[#069A8E] space-x-2 text-white inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none">
