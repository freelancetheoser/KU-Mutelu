      ...
      <div className="flex w-full space-x-4 p-2">
            <form className="w-full " onSubmit={handleSearchChange}>
                <div className="flex space-x-2">
                    ...
                    <div>
                        <button type="submit" className="flex justify-center h-8 space-x-2 rounded-full bg-transparent hover:bg-gradient-to-r from-teal-800 via-teal-500 to-green-400 animate-gradient text-teal-500 hover:text-white shadow px-4 border border-teal-500 hover:border-transparent">
