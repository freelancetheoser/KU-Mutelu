...
export default function MuProfile({wishes, auth}) {
    console.log(wishes);
    const {user} = auth;
            ...
            <div>
                ...
                <div>
                            ...
                            <div className="w-full">
                                <div className="flex justify-center items-center p-2 rounded-full">
                                    <img src={image_profile} alt=""
                                         className="w-32 h-32 rounded-full p-2 border-4 border-teal-500"/>
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="mb-2 ">
                            <ul className="grid grid-cols-2 text-md font-bold">
                                <li className="flex justify-center">
                                    <button onClick={() => setActivePostType('text')}
                                            className="space-y-4 text-gray-400 active:text-[#005555] focus:text-[#005555]">
                                ...
                                <li className="flex justify-center">
                                    <button onClick={() => setActivePostType('frame')}
                                            className="text-gray-400 active:text-[#005555] focus:text-[#005555]">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             fill="currentColor" className="bi bi-image" viewBox="0 0 16 16">
                    ...
                    <div className='grid grid-cols-1 gap-4 justify-center'>
                        ...
                        {activePostType === 'text' &&
                            wishes.map((wish) => (
                                <TextPost key={wish.id} wish={wish}/>
                            ))
                        }
                    </div>
