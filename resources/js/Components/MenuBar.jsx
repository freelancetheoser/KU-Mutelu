    ...
    return (
        <article className="flex justify-center space-x-12">
            <div className="h-72 w-40 bg-gradient-to-br from-green-400 via-teal-500 to-sky-800 drop-shadow-lg rounded-xl opacity-75">
                <img src="./test/Green.png" alt="" className="w-full rounded-full"/>
            ...
            <div className="h-72 w-40 bg-gradient-to-br from-green-400 via-teal-500 to-sky-800 drop-shadow-lg rounded-xl opacity-75">
                <img src="./test/Blue.png" alt="" className="w-full rounded-full"/>
                <div className="mx-auto p-4">
                    <h1 className="text-white text-base font-bold">
                        Metaverse
                    <hr />
            ...
            <div className="h-72 w-40 bg-gradient-to-br from-green-400 via-teal-500 to-sky-800 drop-shadow-lg rounded-xl opacity-75">
                <img src="./test/Purple.png" alt="" className="w-full rounded-full"/>
                <div className="mx-auto p-4">
                    <h1 className="text-white text-base font-bold">
                        Shop
                    <hr />
