            ...
            <div className="flex justify-center text-zinc-800">
                <div className="mx-auto flex flex-col items-center my-12">
                    <div className="flex flex-col w-full justify-center items-start">
                        ...
                        <Link as="button" href={route('location.index')}
                            className="flex justify-center mx-auto space-x-2 bg-transparent hover:bg-gradient-to-r from-teal-800 via-teal-500 to-green-400 animate-gradient text-teal-500 hover:text-white  rounded-full shadow py-2 px-4 mt-6 border border-teal-500 hover:border-transparent">
