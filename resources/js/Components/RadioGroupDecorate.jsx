...
export default function RadioGroupDecorate({ onUpdateDecorate }) {
    ...
    const handleValueChange = (value) => {
        ...
        switch (value) {
            case 'standard':
                onUpdateDecorate('Standard'); // อัพเดตข้อความหรือค่าที่ต้องการ
                break;
            case 'locked':
                onUpdateDecorate('Locked');
                break;
            case 'gorikuya':
                onUpdateDecorate('Gorikuya');
                break;
            default:
                onUpdateDecorate('Standard');
        }
    };
